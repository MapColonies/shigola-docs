...
date: 2026-08-17
linktitle: Layered Cache
title: Layered Cache
weight: 8
subtitle: An ordered chain of cache backends, with promotion and non-blocking writes
menu:
  main:
    parent: Documentation
---

> Added by [this fork]({{< ref "/documentation/about-this-fork" >}}). Upstream Tegola supports
> exactly one cache backend.
...
See [Cache Seeding and Purging]({{< ref "/documentation/cache-seeding-and-purging" >}}).
