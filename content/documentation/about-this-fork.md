...
date: 2026-08-17
linktitle: About this fork
title: About this fork
weight: 2
subtitle: What this is, what it adds, and who made Tegola
menu:
  main:
...
See [OGC API - Tiles]({{< ref "/documentation/ogc-api-tiles" >}}).
...
See [Tile matrix sets]({{< ref "/documentation/tile-matrix-sets" >}}).
...
See [Layered cache]({{< ref "/documentation/layered-cache" >}}).
