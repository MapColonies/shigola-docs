...
[this fork]({{< ref "/documentation/about-this-fork" >}}) and documented separately on
...
> See [Upgrading]({{< ref "/documentation/ogc-api-tiles#upgrading--two-breaking-changes" >}}).
...
[`tile_matrix_sets`]({{< ref "/documentation/tile-matrix-sets" >}}), or `WebMercatorQuad` if the key
...
listed under [Layered cache]({{< ref "/documentation/layered-cache#metrics" >}}).
