---
id: shigola-with-maplibre
title: "Shigola With MapLibre"
sidebar_label: "Shigola With MapLibre"
sidebar_position: 2
description: "Load Shigola-served content on a MapLibre Map!"
---

## Introduction

[Shigola](https://github.com/MapColonies/shigola) is a vector tile server written
in Go. Shigola takes geospatial data from a PostGIS Database and slices it into
...
This guide will take you through the steps to get Shigola rendering a map using
MapLibre and visualized in a web browser.

## Getting Started

### Build the Shigola Server

The first thing you'll need is a Shigola endpoint. You can either set one up
locally by following the instructions located in the
[getting started guide](/documentation/getting-started) or you
...
Shigola endpoint which serves up OpenStreetMap (OSM) data.
...
## Add the Layers served by Shigola
...
[getting started guide](/documentation/getting-started) for
shigola using Bonn.
