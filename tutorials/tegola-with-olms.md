...
### Tegola source
The first thing you'll need is a Tegola endpoint. You can either set up one locally by following the instructions located in the [Tegola docs](/documentation/getting-started) or you can use an existing endpoint.
