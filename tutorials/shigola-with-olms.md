---
id: shigola-with-olms
title: "Shigola With OL Mapbox Style (OLMS)"
sidebar_label: "Shigola With OLMS"
sidebar_position: 4
...
[Shigola](https://github.com/MapColonies/shigola) is a vector tile server written in Go. Shigola takes geospatial data from a PostGIS Database and slices it into vector tiles that can be efficiently delivered to any client.
...
To get setup for using OLMS you'll need a Shigola source, a Mapbox stylesheet, and the OLMS library.
