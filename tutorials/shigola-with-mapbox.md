---
id: shigola-with-mapbox
title: "Shigola With Mapbox GL JS"
sidebar_label: "Shigola With Mapbox"
sidebar_position: 2
description: "Load Shigola-served content on a Mapbox GL Map!"
---

## Introduction

[Shigola](https://github.com/MapColonies/shigola) is a vector tile server written
in Go. Shigola takes geospatial data from a PostGIS Database and slices it
...
for rendering MVT and raster maps. Combined with Shigola,
beautiful maps may be rendered with complete control.

This guide will take you through the steps to get Shigola rendering a map
...
[getting started guide](/documentation/getting-started) or
...
be imported. In this case we are using a Shigola endpoint which serves up
