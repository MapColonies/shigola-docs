...
> Added by [this fork](./about-this-fork.md). Upstream Tegola serves its
...
[`/maps/...` routes](./http-endpoints.md) keep serving the same tiles at the
...
[About this fork](./about-this-fork.md).
